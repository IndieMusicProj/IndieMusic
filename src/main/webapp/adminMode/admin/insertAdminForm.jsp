	...
	<div id="grid2co">
		<div class="adminMain">
			<article>
				...
				<div class="adminInfo">
					<form id="updateAdmin"
						action="${pageContext.request.contextPath}/IndieServlet?command=admin_insert" method="post"
						name="formm">
						<table>
							<tr>
								<td>
									...
									<br>
									<input class="size" type="text" name="adm_id">
								</td>
							</tr>
							<tr>
								<td>
									...
									<br>
									<input class="size" type="text" name="adm_pwd">
								</td>
							</tr>
							<tr>
								<td>
									...
									<br>
									<input class="size" type="text" name="adm_email">
								</td>
							</tr>
							<tr>
								<td>
									...
									<br>
									<input class="size" type="text" name="adm_auth">
								</td>
							</tr>
						</table>
						<hr color="#f6f6f6">
