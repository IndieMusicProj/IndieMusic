	...
	<div id="grid2co">
		<div class="adminMain">
			<article>
				...
				<div class="head">
					<span class="listTitle">관리자 계정 리스트</span>
					&nbsp;&nbsp;&nbsp;
					<button class="insertBtn"
						onclick="location.href='${pageContext.request.contextPath}/adminMode/admin/insertAdminForm.jsp'">신규 등록</button>
				</div>
				<table class="list">
					<tr class="trGrid">
						...
						<th class="thead">권한</th>
					</tr>
					<c:forEach items="${adminInfoList}" var="adminInfo">
						<tr class="list" onclick="location.href='IndieServlet?command=admin_detail&adm_num=${adminInfo.adm_num}'">
							<td class="tdframe" >
								<span style="font-size: 20px; color: #4C4C4C;">${adminInfo.adm_num}</span>
							</td>
							<td class="tdframe">
								<span style="font-size: 20px; color: #4C4C4C;">${adminInfo.adm_id}</span>
							</td>
							<td class="tdframe">
								<span style="font-size: 20px; color: #4C4C4C;">${adminInfo.adm_pwd}</span>
							</td>
							<td class="tdframe">
								<span style="font-size: 20px; color: #4C4C4C;">${adminInfo.adm_email}</span>
							</td>
							<td class="tdframe">
								<span style="font-size: 20px; color: #4C4C4C;">${adminInfo.adm_auth}</span>
							</td>
						</tr>
					</c:forEach>
				</table>
