...
<body>
	<div id="main">
		<article>
			...
			<h1 class="title"><b>아이디 찾기 결과</b></h1>
			<table class="size">
				<tr>
					<td class="th">회원님의 이메일 주소로<br><br></td>
				</tr>
				<tr>
					<td class="th">아이디를 발송해드렸습니다.<br><br><br></td>
				</tr>
				<tr>
					<td class="th"><a href="${pageContext.request.contextPath}/member/findPwdForm.jsp">비밀번호가 기억나지 않으세요?</a></td>
				</tr>
			</table>
				<div id="button">
