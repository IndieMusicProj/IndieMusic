...
<body>
	<div id="main">
		<article>
			...
			<form method="post"
				action="${pageContext.request.contextPath}/IndieServlet?command=find_pwd">
				<table class="size">
					<tr>
						<td class="th selected">
					...
					<tr>
						<td>
							<fieldset>
								<input class="size" name="id" type="text" value="" placeholder="아이디 입력">
								<br>
					...
					<tr>
						<td class="th">
							<br>
							<br>
							<a class="hover" href="${pageContext.request.contextPath}/member/findIdForm.jsp">아이디가
								기억나지 않으세요?</a>
							<br>
							<br>
						</td>
					...
					<tr>
						<td class="th">
							<input class="size login" type="submit" value="비밀번호 찾기">
							<br>
						</td>
					</tr>
				</table>
