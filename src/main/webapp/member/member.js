function go_save() {
  if (document.formm.id.value == "") {
    ...
    document.formm.action = "../IndieServlet?command=join";
...
function idcheck() {
  ...
  var url = "../IndieServlet?command=id_check_form&id=" 
...
function post_zip() {
  var url = "../IndieServlet?command=find_zip_num";
  window.open( url, "_blank_1",
...
function go_next() {
  if (document.formm.okon1[0].checked == true) {
    document.formm.action = "../IndieServlet?command=join_form";
    document.formm.submit();
