...
<article class="allchart">
	<div class="topchart">
		...
		<span style="font-size:30px; font-weight:bold;">힙합</span><span style="font-size:25px; font-weight:bold; color:#4C4C4C;">(힙합)</span>
		&nbsp;&nbsp;&nbsp;
	...
	<div class="hide" style="display: none;">
		<form name="onoff" class="formm" action="IndieServlet?command=KorHiphop" method="post">
		...
		<c:forEach items="${getKorHiphopGenre}" var="chartList" varStatus="status" begin="0" end="14" step="1">
			<tr class="line">
...
<div class="mbtn">
		...
		<table class="chart">
			<c:forEach items="${getKorHiphopGenre}" var="chartList" begin="15" varStatus="status">
			<tr class="line">
