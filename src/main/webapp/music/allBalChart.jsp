...
<article class="allchart">
	<div class="topchart">
		...
		<span style="font-size:30px; font-weight:bold;">발라드</span><span style="font-size:25px; font-weight:bold; color:#4C4C4C;">(종합)</span>
		&nbsp;&nbsp;&nbsp;
	...
	<div class="hide" style="display: none;">
		...
		<c:forEach items="${getAllBalladGenre}" var="chartList" varStatus="status" begin="0" end="14" step="1">
			<tr class="line">
...
<div class="mbtn">
		...
		<table class="chart">
			<c:forEach items="${getAllBalladGenre}" var="chartList" begin="15" varStatus="status">
			<tr class="line">
