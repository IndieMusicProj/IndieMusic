...
<article class="allchart">
	...
	<div class="hide" style="display: none;">
		<form name="onoff" class="formm" action="IndieServlet?command=ForPopular" method="post">
		...
		<c:forEach items="${getForPopular}" var="chartList" varStatus="status" begin="0" end="14" step="1">
			<tr class="line">
...
<div class="mbtn">
		...
		<table class="chart">
			<c:forEach items="${getForPopular}" var="chartList" begin="15" varStatus="status">
			<tr class="line">
