...
<article class="allchart">
	<span style="font-size:30px; font-weight:bold;">힙합(Hip Hop)</span> <span style="font-size:1em; font-weight:bold; color:#8C8C8C;">종합</span><br><br>
	<table class="chart">
			<tr>
				<th align="center">순위</th><th></th><th>곡</th><th>아티스트</th><th>앨범</th><th>듣기</th><th>담기</th><th>가사</th>
			</tr>
		<c:forEach items="${getForHiphopGenre}" var="chartList" varStatus="status">
			<tr class="line">
