...
<article class="allchart">
	<div class="topchart">
		...
		<span style="font-size:30px; font-weight:bold;">인기차트</span><span style="font-size:25px; font-weight:bold; color:#4C4C4C;">(종합)</span>
		&nbsp;&nbsp;&nbsp;
	...
	<div class="hide" style="display: none;">
		<form name="onoff" class="formm" action="IndieServlet?command=AllBallad" method="post">
		...
		<c:forEach items="${getAllPopular}" var="chartList" begin="0" end="14" step="1" varStatus="status">
			<tr class="line">
		...
		<table class="chart">
			<c:forEach items="${getAllPopular}" var="chartList" begin="15" varStatus="status">
			<tr class="line">
