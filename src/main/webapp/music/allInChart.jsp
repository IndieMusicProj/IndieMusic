...
<article class="allchart">
	<div class="topchart">
		...
		<span style="font-size:30px; font-weight:bold;">인디</span><span style="font-size:25px; font-weight:bold; color:#4C4C4C;">(종합)</span>
		&nbsp;&nbsp;&nbsp;
		<button onclick="location.href='IndieServlet?command=AllIndie'">종합</button>
		<button onclick="location.href='IndieServlet?command=KorIndie'">국내</button>
		<button onclick="location.href='IndieServlet?command=ForIndie'">해외</button>
	</div>
	<table class="chart">
	<div class="hide" style="display: none;">
		<form name="onoff" class="formm" action="IndieServlet?command=AllIndie" method="post">
		...
		<c:forEach items="${getAllIndieGenre}" var="chartList" varStatus="status" begin="0" end="14" step="1">
			<tr class="line">
...
<div class="mbtn">
		...
		<table class="chart">
			<c:forEach items="${getAllIndieGenre}" var="chartList" begin="15" varStatus="status">
			<tr class="line">
