...
<article class="allchart">
	<div class="topchart">
		...
		<span style="font-size:30px; font-weight:bold;">발라드</span><span style="font-size:25px; font-weight:bold; color:#4C4C4C;">(해외)</span>
		&nbsp;&nbsp;&nbsp;
	...
	<div class="hide" style="display: none;">
		<form name="onoff" class="formm" action="IndieServlet?command=ForBallad" method="post">
		...
		<c:forEach items="${getForBalladGenre}" var="chartList" varStatus="status" begin="0" end="14" step="1">
			<tr class="line">
...
<div class="mbtn">
		...
		<table class="chart">
			<c:forEach items="${getForBalladGenre}" var="chartList" begin="15" varStatus="status">
			<tr class="line">
